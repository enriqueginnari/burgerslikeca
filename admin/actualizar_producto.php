...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['precio']=='')
		{	
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Pro_img/productos/".basename($fnew);                      // the path to store the upload image
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Tamaño maximo de la imagen 1024kb!</strong> Prueba una imagen diferente.
															</div>';
									...
									else
										{
												...
												$sql = "update productos set titulo='$_POST[d_name]',descripcion='$_POST[about]',precio='$_POST[precio]',img='$fnew' where p_id='$_GET[pro_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong></strong>Actualizado.
															</div>';
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false">  <span><i class="fa fa-user f-s-20 "></i></span><span class="hide-menu">Administradores</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="select * from productos where p_id='$_GET[pro_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" value="<?php echo $roww['titulo'];?>" class="form-control" placeholder="">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['descripcion'];?>" class="form-control form-control-danger" placeholder="">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="precio" value="<?php echo $roww['precio'];?>"  class="form-control" placeholder="$">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
