											...
											<?php
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="7"><center>No hay Administradores!</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['nombre'].'</td>
																								<td>'.$rows['correo'].'</td>																							
																								<td>'.$rows['fecha'].'</td>
																									 <td><a href="borrar_admin.php?admin_del='.$rows['adm_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="actualizar_admin.php?admin_upd='.$rows['adm_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
