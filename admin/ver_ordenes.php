...
<script language="javascript" type="text/javascript">
    ...
    popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+800+',height='+300+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
    }
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql="SELECT usuarios.*, ordenes.* FROM usuarios,ordenes where usuarios.u_id=ordenes.u_id and o_id='".$_GET['usuario_upd']."'";
                                                $query=mysqli_query($db,$sql);
                                                $rows=mysqli_fetch_array($query);
                                                $array_deco = UtilHelper::arrayDecode($rows['p_id']);
											?>
											
                                                <tr>
                                                    <td><strong>Nombre de Usuario:</strong></td>
                                                    <td><center><?php echo $rows['u_nombre']; ?></center></td>
                                                    <td>
                                                        <center>
                                                            <a href="javascript:void(0);" onClick="popUpWindow('actualizar_ordenes.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                                                <button type="button" class="btn btn-primary">Tomar Accion</button>
                                                            </a>
                                                        </center>
                                                    </td>																									
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a href="javascript:void(0);" onClick="popUpWindow('perfil_usuario.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                                                <button type="button" class="btn btn-primary">Ver detalles de usuario</button>
                                                            </a>
                                                        </center>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center><?php echo $rows['fecha']; ?></center></td>                                                                                                                                                
                                                </tr>
